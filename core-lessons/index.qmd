...
“Better science” means science that is more open, reproducible, efficient, and also more diverse, equitable, inclusive, kind. And “future us” is ourselves, teams, communities in the next hour, week, decades – with a focus on onboarding ourselves and others to ongoing work.
...
- A more open culture in your group
  - dedicated group meetings to discuss workflows and psychological safety
    - **“Seaside chats”** to regularly skill-share ([Lowndes et al. 2019](https://openscapes.github.io/supercharge-research/), [2024](https://onlinelibrary.wiley.com/doi/10.1002/ece3.11341)) 
  - stated **code of conduct** or lab group philosophy
  - beginnings of a group **pathway** (roadmap) of shared data workflows
...
Example lessons from the Ocean Health Index team's Seaside Chats:
...
- [Practical Computing for Biologists](https://practicalcomputing.org/). Introduction to the Terminal/command line, introduction to regular expressions. Chapter 2 alone is incredibly powerful for building immediate cross-software skills and thinking differently (Disclosure: Lowndes was an alpha reviewer in grad school).
- Virtual meetings
