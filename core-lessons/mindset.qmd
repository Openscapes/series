...
[Openscapes Mindset - NASA Champions](https://docs.google.com/presentation/d/1sEaWbBIzJqkbeRVJsOJvWK0LI4nrr0iniLRhHNaiqK0/edit?usp=sharing)
:::
...
"Future Us" builds from the idea of "Future You/Future Self" being your most important collaborator (see [Wilson et al 2017](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1005510)) but with a team science mindset promoting diversity, equity, inclusion, and belonging. How can you work today so that someone other than yourself could reproduce/contribute tomorrow? We describe this more in [Lowndes et al. 2019](https://openscapes.github.io/supercharge-research/). This mindset is really critical for progress: how you can work now so that you can succeed later (whether that's this afternoon or 4 years from now, whether it's for you or someone you don't know who will pick up where you left off).

### Reimagine challenges

**Reimagine challenges -- expect there is a better way**

Reimagining challenges is based on the idea that there is a better way that already exists — and that you can find and make us of it. It is the idea of reusing rather than reinventing. It is a release from lonely struggles that also reduces the cognitive load associated with starting from scratch. This means no more silently struggling, reducing the times you reinvent the wheel, and reducing the times you create weird, homegrown workarounds.
...
![Open data science as a beautiful feedback loop.](images/feedback-loop-tooling-people.png){fig-alt="Two illustrations connected by arrows that form a feedback loop between the two. The first illustration is some oak trees and grass that says \"Tooling: tools & practices\" and the second is many hands coming together in the center that says \"People: teams & community\"" fig-align="center" width="70%"}
...
Data science is "the discipline of turning raw data into understanding" - [R for Data Science](https://r4ds.hadley.nz/) (Wickham, Çetinkaya-Rundel & Grolemund 2023).
...
![Image from R for Data Science by Wickham & Grolemund](images/r4ds_data-science.png){fig-align="center" width="70%"}
...
![From Wickham 2017, Welcome to the tidyverse](images/tidyverse_wickham_pres.png){fig-align="center" width="70%"}
...
Learn from, with, and for others ([Lowndes 2019](https://www.scientificamerican.com/blog/observations/open-software-means-kinder-science/)). This helps overcome isolation, self-taught bad practices, apprehension ([Stevens et al. 2018](https://www.biorxiv.org/content/early/2018/02/15/265421)). It helps you transform from "self-taught" to "community-taught".

> "Everyone in the community, no matter how accomplished they are in their
> own specialty, comes with a **mind open to learning from, with, and for
> each other.**
>
