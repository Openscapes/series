...
Openscapes GitHub Clinic introduces GitHub with the motivation of
collaboration and open science. It is designed for both new and seasoned
learners, focused on how develop workflows with diverse teams.

**Slides** that have been presented during Champions Program Cohort Calls:

-   [**GitHub Clinic Slides**](https://docs.google.com/presentation/d/1PzGAbEpNhT6CDPe1DCHf5-eVAjy-2R2D3VMHz7dY774/edit?usp=sharing)
