...
Remeber GitHub's search is awesome – it will search all of your files
and also Issues! <!---I find this really helpful...--->
...
example of the "traditional" use of Issues, which is in a pretty pure
software development context. This is a public repository, and all
topics are directly related to ggplot2. Issues are largely used to
report bugs, troubleshoot and sometimes to request features. Note the
...
You have a lot of control over how you will manage your Projects. Here
is one view:
...
Here's an example of how we might demonstrate using Issues.

Let’s see what Issues look like & then we’ll practice these together.\
Example cohort repo: <https://github.com/Openscapes/2026-esa>.

We’ve been in the code tab so far; there are others you can explore,
starting with Issues

-   Issue: Call 1 Digest. Add an emoji.
    -   Emojis to some feel frivolous or unprofessional but they are a
        low-effort way to communicate you’ve read or appreciated a
        thing.
-   New issue “A question about the data”
    -   add a heading using
...
-   See URL
-   Add a comment
-   Back to main Issues view

Examples in case they come up:

Link to a specific line of code ex:
<https://github.com/amfriesz/lpdaac_hls_tutorial/blob/main/environment.yml#L30> 

See other repo with issues:
...
-   Go to our Cohort repo (Example repo:
...
Have fun! And throughout the process, talk to your colleagues, and share
what you learn.
...
always switch your Watch setting for this repository to "Participating
and \@mentions" so that you only receive email notifications about
Issues that you created, are tagged in, or commented on.

::: callout-tip
## Issues Demo - Review

After a round of breakouts where participants practice using Issues,
screenshare for a brief regroup.

Show

-   number of issues
-   open and closed issues
-   comments - can view number of comments on a list of issues
-   close the issue “A question about the data”
    -   note the URL remains the same.
    -   Persistent URL -\> project memory
-   Watch Settings
    -    different settings for different responsibilities
    -    switch to e.g. "Participating and \@mentions" so that you only receive email notifications about Issues that you created, are tagged in, or commented on.
:::
