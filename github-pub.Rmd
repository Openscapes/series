...
My de nition of collaboration includes hands-on participation by multiple people, including
...
Note: locally, I interact with GitHub through RStudio 99.9% of the time (use command line .1% of time). There is also a chapter on [R, RStudio, and RMarkdown](http://ohi-science.org/data-science-training/rstudio.html). If you use R, then **the** best resource to learn GitHub is Jenny Bryan's [Happy Git With R](https://happygitwithr.com/).
