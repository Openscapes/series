...
This book is the lesson series for the [**Openscapes Champions program**](https://www.openscapes.org/champions/). It improved iteratively and the most recent version always openly available online.

Chapters in this book accompany slide decks and agendas for the Champions program Cohort Calls. Cohort Calls are when cohorts of ~7 research teams (~28 individuals) convene remotely to explore open data science practices. We are testing and learning from Cohorts of different durations as we continue to improve and grow Openscapes. [Below are agendas](#agendas) from 2-month, 4-month, and 2-day iterations. 
