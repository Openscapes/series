...
This book is a lesson series that will introduce you to open practices and data science. *It is under heavy development*.

It is modeled after [Mozilla's Open Leadership Training Series](https://mozilla.github.io/open-leadership-training-series).

----

Openscapes is run by Julia Stewart Lowndes, a Mozilla Fellow and marine scientist at the National Center for Ecological Analysis & Synthesis (NCEAS). Learn more at [openscapes.org](https://openscapes.org).
