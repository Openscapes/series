...
Research teams participate as a cohort over several months, meeting twice-monthly for 1.5-hour sessions we call Cohort Calls. Cohort Calls are designed to be engaging, requiring discussion and active participation through live-notetaking in Google Docs and video Zoom (group and breakouts). 
...
Between Cohort Calls, each team meets for a [Seaside Chat](https://www.openscapes.org/blog/2019/03/10/seaside-chats/), which have been described by participants as one of the most valuable parts of the Champions Program. We also have hands-on skill-building Clinics and Co-Working sessions (which differ from "Office Hours" because participants come to work and learn together).
...
- [GitHub](https://docs.google.com/document/d/1puf1UG7HVwZwnbfc0mlBIzCSGvc-99TcTOdmPHzqZc4/edit?usp=sharing): hands-on from the browser to explore collaborative research through editing, committing, and GitHub Issues.
...
The four-month Champions program includes 8 Cohort Calls and 2 Clinics. Beginning with the core lessons from the two-month program, we work with partners to co-develop new curriculum specific to a community, as illustrated below.  
