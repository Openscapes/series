...
**Outcomes:** different for everybody - this is about getting your own work done. Together we'll work on changing habits to improve your work and teamwork so you shape where you invest based on what you need. We'll also develop a practice of talking and collaborating about data workflows with your team and community, and have a tangible pathway that you identify with your team to help prioritize next steps that your team will share as work-in-progress on our last Cohort Call. This pathway is a planning document that folks have found valuable to share with supervisors as a concrete outcome.

**Process:** through facilitated Cohort Calls, team-driven Seaside Chats & Coworking, and How We Work — which is how we describe the tech & cultural norms we practice, described in our Flywheel. Read on to learn more about these below.

## Cohort Calls

Research teams participate as a Champions Cohort with ~7 total teams over 2 months, meeting twice-monthly for five 1.5-hour sessions we call Cohort Calls. Teams will focus on their own work, with Cohort Calls introducing concepts, tooling, and examples from their peers with time to reflect as individuals, small groups, and across teams. 

Cohort Calls are highly-structured and designed to be engaging, requiring discussion and active participation through shared live notetaking in Google Docs and group/breakout-group discussions.  At the end of the program, each team describes their work in progress and pathways forward.
...
"How We Work" refers to the technical and cultural norms we will establish during the Champions Cohort, which we developed through our [Openscapes Flywheel](https://openscapes.org/approach#openscapes-flywheel).
