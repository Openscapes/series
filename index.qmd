...
See the [Champions Program webpage](https://www.openscapes.org/champions/) for programmatic details (including frequently asked questions like [what is a team](https://www.openscapes.org/faq/)). To learn what teams accomplish, explore [stories from 18+ previous cohorts](https://openscapes.org/blog#category=champions).
